...
export const demoMenuData: PublicMenuResponse = {
  ...
  menu: [
    // Food - Starters
    {
      ...
      mainCategory: { _id: 'mc1', name: 'Food', order: 1 },
      category: { _id: 'c1', name: 'Starters', mainCategory: 'mc1', restaurant: 'demo', order: 1 },
    ...
    // Food - Breads
    {
      ...
      mainCategory: { _id: 'mc1', name: 'Food', order: 1 },
      category: { _id: 'c3', name: 'Breads', mainCategory: 'mc1', restaurant: 'demo', order: 3 },
      name: 'Butter Naan', description: 'Soft leavened bread brushed with butter',
      price: 60, isVeg: true, order: 1,
    },
    {
      ...
      price: 80, isVeg: true, order: 2,
    },
    // Bar - Whisky
    {
      _id: '9', restaurant: 'demo',
      mainCategory: { _id: 'mc2', name: 'Bar', order: 2 },
      category: { _id: 'c4', name: 'Whisky', mainCategory: 'mc2', restaurant: 'demo', order: 1 },
      name: 'Jack Daniels', description: 'Tennessee whiskey, 30ml',
      price: 450, isVeg: true, order: 1,
    },
    {
      ...
      price: 550, isVeg: true, order: 2,
    },
    // Bar - Vodka
    {
      _id: '11', restaurant: 'demo',
      mainCategory: { _id: 'mc2', name: 'Bar', order: 2 },
      category: { _id: 'c5', name: 'Vodka', mainCategory: 'mc2', restaurant: 'demo', order: 2 },
      name: 'Absolut', description: 'Premium Swedish vodka, 30ml',
      price: 350, isVeg: true, order: 1,
    },
    {
    ...
    // Beverages - Mocktails
    {
      ...
      mainCategory: { _id: 'mc3', name: 'Beverages', order: 3 },
    ...
    // Beverages - Soft Drinks
    {
      ...
      mainCategory: { _id: 'mc3', name: 'Beverages', order: 3 },
      category: { _id: 'c7', name: 'Soft Drinks', mainCategory: 'mc3', restaurant: 'demo', order: 2 },
      name: 'Fresh Lime Soda', description: 'Choice of sweet or salted',
      price: 80, isVeg: true, order: 1,
    },
    {
